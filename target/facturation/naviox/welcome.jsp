...
In facturation-labels_en.properties:
facturation=My application
facturation[description]=My application does this and that

In facturation-messages_en.properties:
